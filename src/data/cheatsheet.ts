...
export const cheatEntries: CheatEntry[] = [
  ...
  { command: 'git switch <name>', description: 'Switch branches (the modern checkout — prefer over git checkout).', category: 'Branching & merging', example: 'git switch feature/login' },
  ...
  { command: 'git pull --rebase', description: 'Fetch and replay your commits on top of the remote (linear history).', category: 'Branching & merging', example: 'git pull --rebase' },
  ...
  { command: 'git push --force-with-lease', description: 'Safer force-push: aborts if remote moved since you fetched.', category: 'Remotes & GitHub', example: 'git push --force-with-lease' },
  { command: 'git config --global pull.rebase true', description: 'Make pull --rebase the default to avoid merge bubbles.', category: 'Remotes & GitHub', example: 'git config --global pull.rebase true' },
  ...
  // ── Undo & rescue ──
  { command: 'git restore <file>', description: 'Discard unstaged edits to a file (modern replacement for checkout --).', category: 'Undo & rescue', example: 'git restore config.txt' },
  ...
  { command: 'git clean -n / -f', description: 'Preview / delete untracked files (build artifacts). Always -n first.', category: 'Undo & rescue', example: 'git clean -n' },
  ...
  { command: 'git commit --fixup <sha>', description: 'Mark a fix to be autosquashed into an earlier commit on rebase.', category: 'Undo & rescue', example: 'git commit --fixup a1b2c3d' },
  { command: 'git rebase --autosquash -i HEAD~n', description: 'Auto-squash fixup! commits into their targets.', category: 'Undo & rescue', example: 'git rebase --autosquash -i HEAD~3' },
  ...
  { command: 'git config --global gpg.format ssh', description: 'Sign commits with your SSH key (no GPG needed).', category: 'Undo & rescue', example: 'git config --global gpg.format ssh' },
  { command: 'gh pr create --fill', description: 'Create a GitHub PR from the current branch (GitHub CLI).', category: 'Remotes & GitHub', example: 'gh pr create --fill' },
  { command: 'gh pr checks', description: 'Show CI status for your PR without opening a browser.', category: 'Remotes & GitHub', example: 'gh pr checks' },
  { command: 'gh issue create', description: 'Create an issue from the terminal.', category: 'Remotes & GitHub', example: 'gh issue create --title "Bug: ..."' },
]
